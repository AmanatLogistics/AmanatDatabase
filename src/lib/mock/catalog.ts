...
/**
 * The products Amanat actually moves. `costUsd` is what the store charges us;
 * the client price is derived from it at order-build time using the FX rate and
 * the service fee, exactly the way the team quotes in real life.
 */
