...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "border-border/60 bg-popover text-popover-foreground grid min-w-[9rem] items-start gap-1.5 rounded-lg border px-3 py-2 text-xs shadow-lg",
        className,
      )}
    >
      {!hideLabel && label != null && (
        <div className="text-foreground pb-0.5 font-medium">
        ...
        {payload.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-foreground tabular ml-auto font-medium">
